...
public class Deployment extends UuidEntity{
	...
	private Timestamp dplStartTime;
	private Timestamp dplEndTime;
	...
	public Timestamp getDplStartTime() {
		return dplStartTime;
	}
	public void setDplStartTime(Timestamp dplStartTime) {
		this.dplStartTime = dplStartTime;
	}
	public Timestamp getDplEndTime() {
		return dplEndTime;
	}
	public void setDplEndTime(Timestamp dplEndTime) {
		this.dplEndTime = dplEndTime;
	}
